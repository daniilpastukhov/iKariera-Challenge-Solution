...
**
**  Input:
**  An integer array of length 0 < array < 1000. The numbers in the array can be any integer positive or negative.
**
**  Output:
    ...
    public static class EqualSidesOfAnArray
    {
        public static int FindEvenIndex(int[] array)
        {
            ...
            for (int i = 0; i < array.Length; i++)
            {
                ...
                {
                    if (i < j) leftSum += array[j];
                    else if (i > j) rightSum += array[j];
                }
